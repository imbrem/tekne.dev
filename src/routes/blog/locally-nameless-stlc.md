...
[^2]:
    In fact, [the tutorial](https://www.chargueraud.org/research/2009/ln/main.pdf) uses a
    well-formedness judgement on page 19 to do exactly that

[^3]:
    That solved it. I mention this because I once destroyed the clutch on my KTM125 riding back
...
[^4]:
    And they're good with bikes, too! They've got secure storage in the back, though overall it's

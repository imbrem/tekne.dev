...
[^2]:
    Of course, the same program compiled by different compilers can also vary in performance. That
...
[^3]:
    I am reminded of this [Stack Overflow
...
[^6]:
    Unlike C, Rust does not have a stable ABI. As for C++,
